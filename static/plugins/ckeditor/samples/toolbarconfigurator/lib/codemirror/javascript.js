    ...
    p.defineMode("javascript", function (oa, t) {
        ...
        var C = oa.indentUnit, na = t.statementIndent, L = t.jsonld, D = t.json || L, ka = t.typescript,
            R = t.wordCharacters || /[\w$\xa1-\uffff]/, ba = function () {
                ...
                var c = a("keyword a"), b = a("keyword b"), d = a("keyword c"), f = a("operator"),
                    h = {type: "atom", style: "atom"}, c = {
                        "if": a("if"),
                        "while": c,
                        "with": c,
                        "else": b,
            ...
            qa = /^@(context|id|value|language|type|container|list|set|reverse|index|base|vocab|graph)"/, E, I,
