...
class Inventory(models.Model):
    ...
    fk_structure = models.ForeignKey('system.Structure', null=True, blank=True, on_delete=models.SET_NULL, verbose_name="當前使用部門")
...
class OperateCacheTable(models.Model):
    ...
    fk_structure = models.ForeignKey('system.Structure', null=True, blank=True, on_delete=models.SET_NULL, verbose_name="申請部門")
...
class Apply(models.Model):
    ...
    applyState = models.CharField(max_length=30, choices=APPLYSTATE_TYPE, default="1", blank=True, verbose_name="申請狀態", )
...
class ApplyDetail(models.Model):
    ...
    machineState = models.CharField(max_length=30, choices=MACHINE_STATE, default="1", blank=True, verbose_name="機台確認狀態", )
